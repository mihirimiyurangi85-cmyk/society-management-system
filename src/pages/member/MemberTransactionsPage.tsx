...
export const MemberTransactionsPage: React.FC = () => {
  ...
  const columns: Column<FundTransaction>[] = [
    ...
    { header: 'Category', accessor: 'category' },
    {
      header: 'Amount',
      accessor: (t) => (
        <span className={`font-bold ${t.type === 'INCOME' ? 'text-emerald-400' : 'text-purple-400'}`}>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-white">Society Public Transaction Log</h1>
        <p className="text-xs text-slate-400">Transparent summary of society income and welfare assistance</p>
      </div>
